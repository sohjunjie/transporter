...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										FirstName LastName - Web Developer <small>Member since
											Nov. 2012</small>
									</p></li>
								<!-- Menu Footer-->
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="${resourcePath}dist/img/avatar.jpg" class="img-circle"
							alt="User Image">
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
							class="fa fa-car"></i> <span>Accident Report</span> <span
						...
						<ul class="treeview-menu">
							<li><a href="index.html">
								<i class="fa fa-flag-o" style="color:white"></i> Pending
							...
							<li><a href="index2.html">
								<i class="fa fa-flag-o" style="color:red"></i> Approved</a></li>
							<li><a href="index2.html">
								<i class="fa fa-flag-o" style="color:yellow"></i> Resolved</a></li>
						</ul></li>

					<li><a href="pages/widgets.html"> <i class="fa fa-video-camera"></i>
							<span>Enforcement Camera</span> <span class="pull-right-container"> <small
								class="label pull-right bg-green">new</small>
						</span>
					</a></li>

					<li><a href="pages/widgets.html"> <i class="fa fa-dashboard"></i>
							<span>Statistics</span> <span class="pull-right-container"> <small
								class="label pull-right bg-green">new</small>
						</span>
					</a></li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2017 <a href="#">transporter inc.</a>.
